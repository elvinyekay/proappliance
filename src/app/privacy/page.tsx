    ...
    <main id="main">
      ...
      <section className="privacy container">
        <div className="privacy-content">
          <h2 className="privacy-title">Privacy and Policy</h2>
          <p className="privacy-sub">Last updated: April 06, 2024</p>
          <p>
          ...
          <p>
            ...
            “Our” in this Agreement) refers to Fasteny Appliance Repair LLC, 656
            Ocean Ave, Revere, MA 02151, Apt 621.
          </p>
          <p>
          ...
          <p>
            Website refers to Pro Appliance Express, accessible from
            <a href="#">https://proappliance.com/</a>
          </p>
          <p>
